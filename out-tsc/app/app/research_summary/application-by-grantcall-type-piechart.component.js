...
var ApplicationByGrantcallTypePieChartComponent = (function (_super) {
    __extends(ApplicationByGrantcallTypePieChartComponent, _super);
    function ApplicationByGrantcallTypePieChartComponent(ref, dashboardService, router, expandedViewDataservice, dashboardData) {
    ...
    ApplicationByGrantcallTypePieChartComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    ApplicationByGrantcallTypePieChartComponent.prototype.ngOnDestroy = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
            this.resultPie = {};
        }
    };
    ApplicationByGrantcallTypePieChartComponent.prototype.drawGraph = function () {
    ...
    ApplicationByGrantcallTypePieChartComponent.prototype.onResize = function (event) {
        this.grantCallChart.draw(this.piechartDrawData, this.piechartOptions);
    };
    ApplicationByGrantcallTypePieChartComponent = __decorate([
        Component({
    ...
    return ApplicationByGrantcallTypePieChartComponent;
}(GoogleChartService));
export { ApplicationByGrantcallTypePieChartComponent };
//# sourceMappingURL=application-by-grantcall-type-piechart.component.js.map